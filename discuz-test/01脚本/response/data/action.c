Action()
{
	...
	web_url("appcenter.gif", 
		"URL=http://addons.g-fox.cn/appcenter.gif?t=0&a=002&d=0&r=0.44652720668045687&cid=full.firefox.com.cn", 
		"Resource=1", 
		"RecContentType=image/gif", 
		"Referer=", 
		"Snapshot=t3.inf", 
	...
	web_add_cookie("__utma=265356880.1632274347.1466129867.1466487506.1466491607.5; DOMAIN=api.app.mozilla.com.cn");

	web_add_cookie("__utmz=265356880.1466129867.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); DOMAIN=api.app.mozilla.com.cn");

	web_add_cookie("__utmb=265356880.1.10.1466491607; DOMAIN=api.app.mozilla.com.cn");
	...
	web_url("inner", 
		...
		"Mode=HTML", 
		EXTRARES, 
		"Url=http://www.google-analytics.com/r/__utm.gif?utmwv=5.6.7&utms=2&utmn=584470052&utmhn=api.app.mozilla.com.cn&utmcs=UTF-8&utmsr=1366x768&utmvp=1123x525&utmsc=24-bit&utmul=zh-cn&utmje=0&utmfl=-&utmdt=%E7%81%AB%E7%8B%90%E5%BA%94%E7%94%A8%E4%B8%AD%E5%BF%83&utmhid=796769331&utmr=-&utmp=%2Finner%2F&utmht=1466492449542&utmac=UA-2826582-7&utmcc=__utma%3D265356880.1632274347.1466129867.1466487506.1466491607.5%3B%2B__utmz%3D265356880.1466129867.1.1.utmcsr%3D(direct)%7Cutmccn%3D(direct)%7Cutmcmd%3D(none)"
		"%3B&utmjid=177228999&utmredir=1&utmu=qBAAAAAAAAAAAAAAAAAAAAAE~", ENDITEM, 
		LAST);
