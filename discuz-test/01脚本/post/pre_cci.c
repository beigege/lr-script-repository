# 1 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c"
...
# 1 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
...
# 2 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
...
# 3 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
...
# 4 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
...
# 95 "post.c"
	...
	web_submit_data("forum.php_7", 
		...
		"Name=subject", "Value={username}post{postid}-title", "ENDITEM", 
		"Name=message", "Value={username}post{postid}-content\r\n", "ENDITEM", 
	...
	lr_end_transaction("post", 2);

	return 0;
}

# 5 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
...
# 6 "d:\\my\\study\\performance\\lrtest-script\\post\\\\combined_post.c" 2
