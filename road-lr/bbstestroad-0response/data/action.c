Action()
{
	...
	web_url("appcenter.gif", 
		"URL=http://addons.g-fox.cn/appcenter.gif?t=0&a=002&d=0&r=0.340009448328374&cid=full.firefox.com.cn", 
		"TargetFrame=", 
		"Resource=1", 
		"RecContentType=image/gif", 
		"Referer=", 
	...
	web_url("appcenter.gif_2", 
		"URL=http://addons.g-fox.cn/appcenter.gif?t=0&a=001&d=tab-install&r=0.561267704034647&cid=full.firefox.com.cn", 
		"TargetFrame=", 
		"Resource=1", 
		"RecContentType=image/gif", 
		"Referer=", 
	...
	web_add_cookie("eFID_2132_saltkey=V770O6lw; DOMAIN=bbs.testroad.org");

	web_add_cookie("eFID_2132_lastvisit=1480398698; DOMAIN=bbs.testroad.org");

	web_add_cookie("eFID_2132_sid=L5N6Nn; DOMAIN=bbs.testroad.org");

	web_add_cookie("eFID_2132_lastact=1480407074%09forum.php%09; DOMAIN=bbs.testroad.org");

	web_add_cookie("safedog-flow-item=A873C8689BFDF3640924F2B1CEB660B7; DOMAIN=bbs.testroad.org");

	web_add_cookie("pgv_pvi=8882643722; DOMAIN=bbs.testroad.org");

	web_add_cookie("eFID_2132_forum_lastvisit=D_15_1480402505; DOMAIN=bbs.testroad.org");

	web_add_cookie("eFID_2132_visitedfid=15; DOMAIN=bbs.testroad.org");
	...
	web_add_cookie("eFID_2132_onlineusernum=9; DOMAIN=bbs.testroad.org");

	web_add_cookie("__ysuid=14695999014221cq; DOMAIN=static.youku.com");
